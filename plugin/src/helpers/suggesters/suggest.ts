...
export abstract class TextInputSuggest<T> implements ISuggestOwner<T> {
  ...
  constructor(app: App, inputEl: HTMLInputElement | HTMLTextAreaElement) {
    ...
    // eslint-disable-next-line obsidianmd/prefer-create-el -- the global factory is bound to
    // the main window's document, so it cannot build the popup in the window the input is in.
