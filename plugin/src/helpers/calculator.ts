/**
 * The calculator in a number property: `+ − × ÷` and brackets over decimal numbers, parsed here
 * and nowhere near `eval`. A comma is a decimal point, as a phone's number pad writes it in much of
...
/** The value of the text, or `null` when it is not arithmetic this calculator understands. */
