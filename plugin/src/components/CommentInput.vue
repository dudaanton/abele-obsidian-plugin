<template>
  <div class="abele-comment-input" :class="{ 'abele-comment-input_modal': host === 'modal' }">
...
const props = withDefaults(
  defineProps<{
     ...
     *
     * A margin composer is a 300 px sidenote and is set small to fit one. A modal is the whole
...
/**
 * A phone, and the modal that is a phone's only host for a card.
 *
 ...
 */
.abele-comment-input_modal .abele-comment-input__field,
...
.abele-comment-input_modal .abele-comment-input__mic,
body.is-mobile .abele-comment-input__mic,
.abele-comment-input_modal .abele-comment-input__note,
body.is-mobile .abele-comment-input__note,
.abele-comment-input_modal .abele-comment-input__send,
