/**
 * The version a tab's links into the repository stay at: a pull request's or a comparison's head
 * commit, a commit's own SHA, the branch, tag or commit a file or a folder was read at. So a folder opened
