...
echo "--- Building Abele Obsidian Plugin ---"
...
mkdir -p "$TARGET_VAULT_DIR"
echo "Ensured target directory exists: $TARGET_VAULT_DIR"

# Copy built files
cp "$BUILD_DIR/main.js" "$TARGET_VAULT_DIR/main.js"
echo "Copied main.js"
