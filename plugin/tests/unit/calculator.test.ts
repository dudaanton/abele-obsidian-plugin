/**
 * A number property is a calculator: `12.5 + 3*2` is a sum, the way a receipt is added up while
 * it is being typed in. Nothing here runs `eval` — the field parses arithmetic and nothing else.
 */
